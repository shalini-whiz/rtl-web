...
let vendorProfile = [
    ...
    {
        key: "businessDescription", displayName: "Description", order: 4, type: "string",
        error: "", value: "", helperText: "", required: false, titleCase: true, rowsMax: 4,
        multiline: true,
    },
    {
        key: "address", displayName: "Address", order: 5, type: "string",
    ...
    {
        key: "accountName", displayName: "Account Name", order: 6, type: "string",
        error: "", value: "", helperText: "", required: true,
    },
    {
        key: "bankName", displayName: "Bank Name", order: 7, type: "string",
        error: "", value: "", helperText: "", required: true,
    },
    {
    ...
    {
        key: "ifscCode", displayName: "IFSC", order: 9, type: "string",
        error: "", value: "", helperText: "", required: true, titleCase: true, rowsMax: 4
    },
    {
        key: "orderEnabled", displayName: "Enable Orders", order: 10, type: "select",
        select: true,
        error: "", value: "", helperText: "", required: false, options: [
            { value: true, key: "Yes" },
            { value: false, key: "No" }
    ...
    {
        key: "latitude", displayName: "Latitude", order: 11,
        type: "number", error: "", value: "", helperText: "", required: false, titleCase: true
    },
    {
        key: "longitude", displayName: "Longitude", order: 12,
        type: "number", error: "", value: "", helperText: "", required: false, titleCase: true
    }
]
export { profile, vendorProfile };
